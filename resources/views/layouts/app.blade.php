...
@section('body')
    <div class="bg-gray-50 min-h-screen">
        ...
        <div class="md:hidden fixed bottom-1 w-full p-5 px-6 flex items-center justify-between bg-white shadow-lg text-gray-500 rounded-md cursor-pointer">
            <div class="flex flex-col items-center {{ request()->routeIs('dashboard') ? 'text-blue-400' : '' }} transition ease-in duration-200 hover:text-blue-400 ">
            ...
            <div class="flex flex-col items-center  hover:text-blue-400 ">
                <div
                class="absolute bottom-5 shadow-2xl text-center flex items-center justify-center rounded-full border-4 text-xl border-gray-50 hover:border-blue-500 bg-blue-400 w-20 h-20 p-2 text-white transition ease-in duration-200 ">
                +
